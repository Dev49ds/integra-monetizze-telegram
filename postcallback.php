<?php
  ...
  //Chave Unica
  //Verifica se o POST foi enviado pela Monetizze oiu não
  //Compara a chave recebida com a chave gerada no menu Ferramentas->Postback
  $chaveUnica = $dados['chave_unica'];
  if($chaveUnica  != 'a5f8ffab10fbef2ccfa47e3ad16a9453') {
    exit;
  }
 ...
 */
  ...
  */
  ...
  /*
  *	Numero da parcela dessa cobranca
  *
  * Data da criação da assinatura.
  * Formato: yyyy-mm-dd H:i:s
  *
...
/*
    Comentários 2018 adicionados por 
        Jeferson Capobianco <jefersoncapobianco@gmail.com>
        Challenger CRM <http://challengercrm.com>
        
        Obrigado pela contribuição.
*/

/*
    Novos comentários 2020 adicionados por 
        Alex Tigre <dev49ds@gmail.com>
        Criativa Digital <https://alextigre.online/>
